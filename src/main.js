...
function renderHome() {
  setPage("BlogCore - Find an author and read their posts", `<main class="home"><div id="welcome-animation" class="welcome-animation"><img class="welcome-logo" src="${LOGO_URL}" alt="BlogCore" /><img class="welcome-gif" src="${WELCOME_GIF_URL}" alt="BlogCore animation" /></div><h1>Read what authors publish.</h1><p class="lede">Type an author's public username to open their profile and browse every post they have written.</p><div class="home-directory"><form class="search-form" id="author-search"><div class="search-box"><input id="username" type="text" placeholder="Author username, e.g. jane-doe" aria-label="Author username" autocomplete="off" /><ul id="suggestions" class="suggestions" hidden></ul></div><button type="submit">Search</button></form><section class="recommendations" aria-labelledby="recommendations-title"><div class="recommendations-heading"><span id="recommendations-title" class="section-label">Recommendations</span><span class="username">[ 01 author ]</span></div><ul class="recommendation-list"><li><a href="${appUrl("/authors/fveronelli")}"><span class="recommendation-index">01</span><span><strong>Facundo Veronelli</strong><span class="username">/fveronelli</span></span><span class="recommendation-arrow" aria-hidden="true">&#8594;</span></a></li></ul></section></div></main>`);
